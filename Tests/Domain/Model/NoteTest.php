...
/**
 * Testcase for class Tx_Taxonomy_Domain_Model_Note.
 *
 * @version $Id$
 ...
 */
class Tx_Taxonomy_Domain_Model_NoteTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
	 * @var Tx_Taxonomy_Domain_Model_Note
	 */
	protected $fixture;

	public function setUp() {
		$this->fixture = new Tx_Taxonomy_Domain_Model_Note();
	}
