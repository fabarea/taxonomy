...
/**
 * Testcase for class Tx_Taxonomy_Domain_Model_Annotation.
 *
 * @version $Id$
 ...
 */
class Tx_Taxonomy_Domain_Model_AnnotationTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
	 * @var Tx_Taxonomy_Domain_Model_Annotation
	 */
	protected $fixture;

	public function setUp() {
		$this->fixture = new Tx_Taxonomy_Domain_Model_Annotation();
	}
