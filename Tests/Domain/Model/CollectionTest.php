...
/**
 * Testcase for class Tx_Taxonomy_Domain_Model_Collection.
 *
 * @version $Id$
 ...
 */
class Tx_Taxonomy_Domain_Model_CollectionTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
	 * @var Tx_Taxonomy_Domain_Model_Collection
	 */
	protected $fixture;

	public function setUp() {
		$this->fixture = new Tx_Taxonomy_Domain_Model_Collection();
	}
	 ...
	 * @test
	 */
	public function getOrderedReturnsInitialValueForBoolean() { 
		$this->assertSame(
			TRUE,
			$this->fixture->getOrdered()
		);
	}
	 ...
	 * @test
	 */
	public function setOrderedForBooleanSetsOrdered() { 
		$this->fixture->setOrdered(TRUE);
