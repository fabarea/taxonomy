...
if ($GLOBALS['_GET']['M'] == 'user_ExtjsSampleTxExtjssampleM1') {
...
// Note: key "ExtjsSAmple" is the name of the extension in a camel case syntax
$GLOBALS['TYPO3_CONF_VARS']['SC_OPTIONS']['RequireJS']['ExtjsSample'] = Array(
	
	// Files to be loaded
	// Note: files must be prefixed by their Camel Upper Case Extension Key
	//       the path will be resolved by RequireJS
	'Files' => Array (
		'ExtjsSample/Core/Application', 
		'ExtjsSample/Module/UserInterfaceModule',
		'ExtjsSample/Module/ContentBrowserModule',
		'ExtjsSample/Utils',
	),
