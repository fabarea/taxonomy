...
***************************************************************/
Ext.namespace('TYPO3.Taxonomy.UserInterface');

/**
 * @class TYPO3.Taxonomy.UserInterface.DeletionDropZone
 *
 ...
 */
TYPO3.Taxonomy.UserInterface.TreeNodeUI = Ext.extend(Ext.tree.TreeNodeUI, {
	/**
...
//        this.iconNode = cs[2];
		...
		if (!TYPO3.Taxonomy.Configuration.disableIconLinkToContextmenu
			|| TYPO3.Taxonomy.Configuration.disableIconLinkToContextmenu === '0'
		) {
    ...
    onTipChange : function(node, tip, title) {
		TYPO3.Taxonomy.UserInterface.TreeNodeUI.superclass.onTipChange.apply(this, arguments);
	...
	onOver: function() {
		if (!this.node.ownerTree.dontSetOverClass) {
			TYPO3.Taxonomy.UserInterface.TreeNodeUI.superclass.onOver.apply(this, arguments);
		}
	}
});

// XTYPE Registration
Ext.reg('TYPO3.Taxonomy.UserInterface.TreeNodeUI', TYPO3.Taxonomy.UserInterface.TreeNodeUI);
