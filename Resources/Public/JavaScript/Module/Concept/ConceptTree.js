...
define(['Taxonomy/Core/Application'], function(Application) {
	...
	/**
	 * @class TYPO3.Taxonomy.Module.Concept.TreePanel
	 * 
	 ...
	 */
	TYPO3.Taxonomy.Module.Concept.TreePanel = Ext.define('TYPO3.Taxonomy.Module.Concept.TreePanel', {
		 ...
		 * @cfg {String}
		 */
		alias: 'widget.TYPO3.Taxonomy.Module.Concept.TreePanel',
	...
	//		});
			...
			TYPO3.Taxonomy.Module.Concept.TreePanel.superclass.initComponent.call(this);
