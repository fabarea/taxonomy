...
define(['Taxonomy/Core/Application'], function(Application) {
	...
	/**
	 * @class TYPO3.Taxonomy.Components.SearchBar
	 * 
	 ...
	 */
	Ext.define('TYPO3.Taxonomy.Components.SearchBar', {
		 ...
		 * @cfg {String}
		 */
		alias: 'widget.TYPO3.Taxonomy.Components.SearchBar',
		...
		initComponent: function() {
			...
			TYPO3.Taxonomy.Components.SearchBar.superclass.initComponent.call(this);
		},
		
		onRender:function(ct, position) {
			TYPO3.Taxonomy.Components.SearchBar.superclass.onRender.call(this, ct, position);
